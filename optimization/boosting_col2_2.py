...
if __name__ == '__main__':
    ...
    #                              max_rule_num=10, debug=False, reg=r, max_col_num=m)
    for col in [10]:
        res['liver'] = evaluate_boosting2('liver', '../datasets/liver/liver.csv',
    ...
    for col in [5]:
        res['magic'] = evaluate_boosting2('magic', '../datasets/magic/magic04.csv',
                                          ...
                                          max_rule_num=10, debug=False, reg=0.1, cr='c', max_col_num=col)
        res['adult'] = evaluate_boosting2('adult', '../datasets/adult/adult.csv',
    ...
    for col in [4]:
        res['digits5'] = evaluate_boosting2('digits5', '../datasets/digits/digits.csv',
                                            ...
                                            feature_map={
                                                'target': {'5': 1, '0': -1, '1': -1, '2': -1, '3': -1, '4': -1,
                                                           ...
                                                           '7': -1, '8': -1,
                                                           '9': -1}},
                                            target_type=int, tl=250, repeat=5, loss='logistic',
                                            max_rule_num=10, debug=False, reg=0.1, cr='c', max_col_num=col)
    print(res)
